...
public class MovieListActivity extends AppCompatActivity implements HasSupportFragmentInjector {
    ...
    private static final String IS_SEARCH_VIEW_SEARCH_TEXT = "is_search_view_search_text";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            searchViewText = savedInstanceState.getString(IS_SEARCH_VIEW_SEARCH_TEXT);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(IS_SEARCH_VIEW_SEARCH_TEXT, searchViewText);
    }
